...
const ChatPage=()=>{
    ...
    return(
        <div className="">
            {/*this is a header */}
            <header className="dark:border-gray-700 fixed w-full shadow border dark:bg-gray-900 py-5 flex justify-around items-center">
                {/*room name container*/}
                <div className="">
            ...
            <main ref={chatBoxRef} className="pt-20 w-2/3 dark:bg-slate-600 h-screen py-20 px-10 overflow-auto mx-auto">
                {
                        ...
                        return (
                            <div key={index} className={`flex ${message.sender===currentUser ?"justify-end":"justify:start"}`}>
                                ...
                                <div className="flex flex-row gap-2">
                                    <img className="h-10 w-10"src={"https://avatar.iran.liara.run/public/1"} alt=''/>
            ...
            <div className="fixed bottom-4 w-full h-16">
                <div className="h-full  pr-10 gap-4 flex items-center justify-between w-1/2 mx-auto dark:bg-gray-900 rounded-full">
                    ...
                    className="dark:bg-gray-800 dark:border-gray-600 px-5 py-2 w-full rounded-full h-full focus:outline-none "/>
                    ...
                    <button 
                    onClick={sendMessage}
                    className="dark:bg-green-600 h-10 w-10 flex justify-center items-center rounded-full" ><MdSend size={20}/></button>
                    </div>
                </div>
            </div>
        </div>
